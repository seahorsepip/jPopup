function jPopup(a){function I(){"fixed"!=$("html").css("position")||$("[data-popup][data-overlay]").length||($("html").css("position","static"),$("html").scrollTop(-parseInt($("html").css("top"))),$("html").css({width:"",height:"",top:0}))}function n(){e.off("mousedown touchstart");h.off("scroll");d.off("click mousedown touchstart mmouseup touchend");w.children("div").off("mousedown touchstart");$(window).off("resize",z);$(document).off("mousemove touchmove",A);$(document).off("mouseup touchend",
B);d.fadeOut(a.speed,function(){d.remove();I()});k.fadeOut(a.speed,function(){k.remove()});C=!1}function J(){a.overlay?(d.attr("data-overlay",""),k.css("z-index",d.css("z-index")).fadeIn(a.speed),K=$("html").scrollTop(),"fixed"!=$("html").css("position")&&a.overlay&&$("html").css({width:"100%",height:"100%",position:"fixed",top:-K})):(d.removeAttr("data-overlay"),k.fadeOut(a.speed),I())}function L(){a.draggable?(e.css("cursor","move"),"bottom"!=a.position&&"bottomLeft"!=a.position&&"bottomRight"!=
a.position&&"stretchBottom"!=a.position||!a.stickToBottom||(stickToBottom=!1,p()),d.attr("data-draggable","")):(e.css("cursor","inherit"),d.removeAttr("data-draggable"))}function M(){a.resizeable?(w.show(),d.attr("data-resizeable","")):(w.hide(),d.removeAttr("data-resizeable"))}function N(){a.buttons.length?d.attr("data-buttons",""):d.removeAttr("data-buttons")}function O(){a.closeButton?q.show():q.hide()}function p(){switch(a.position){case "center":d.css({width:0,height:0,position:"fixed",top:"50%",
...
a.closeButtonClass+'">'+a.closeButtonContent+"</div></form></div></div>"),d=S.children("div:last-child"),k=S.children("div:first-child"),c=d.children("form"),e=c.children("."+a.titleClass),h=c.children("."+a.contentClass),y=c.children("."+a.buttonsClass),q=c.children("."+a.closeButtonClass),w=c.children("."+a.resizeClass),C,K,l,m,r,t,f,g,G,z,A,B,H,v;this.open=function(b){var u=$.Deferred();$("body").append(k).append(d);J();T();O();L();M();N();p();Q();P();E();d.attr("data-position",a.position).fadeTo(a.speed,
1);C=!0;var x=!1;y.on("click","button",function(a){a.preventDefault();a=$(this).data("value");var b=$(this).data("checkform"),d=$(this).data("close");"function"==typeof document.createElement("input").checkValidity&&b?(console.log(c[0].checkValidity()),c[0].checkValidity()?(x||u.notify(a,c),0!=d&&(n(),x=!0)):$('<input type="submit">').hide().appendTo(c).click().remove()):(x||u.notify(a,c),0!=d&&(n(),x=!0))});q.on("click",function(a){a.preventDefault();n()});h.on("scroll",function(){E()});z=function(){D();
P();E()};$(window).on("resize",z);e.on("mousedown touchstart",function(b){a.draggable&&(G=!0,l=c.offset().top,m=c.offset().left,f=b.pageY||b.originalEvent.touches[0].pageY,g=b.pageX||b.originalEvent.touches[0].pageX,$(document).bind("selectstart.disableSelection",function(a){a.preventDefault()}),$("[data-popup]").css("user-select","none"))});A=function(b){mY=void 0==b.pageY?b.originalEvent.touches[0].pageY:b.pageY;mX=void 0==b.pageX?b.originalEvent.touches[0].pageX:b.pageX;G&&a.draggable&&(c.offset({top:l+
mY-f,left:m+mX-g}),D());H&&a.resizeable&&(/0|4|5/.test(v)&&0<l+mY-f&&(c.css("height",""),r-mY+f>c.height()&&(c.css("height",r-mY+f),c.offset({top:l+mY-f}))),/1|4|6/.test(v)&&0<m+mX-g&&(c.css("width",""),t-mX+g>c.width()&&(c.css("width",t-mX+g),c.offset({left:m+mX-g}))),/2|6|7/.test(v)&&l+mY-f+r<$(window).height()&&(c.css("height",""),r+mY-f>c.height()&&c.css("height",r+mY-f)),/3|5|7/.test(v)&&m+mX-g+t<$(window).width()&&(c.css("width",""),t+mX-g>c.width()&&c.css("width",t+mX-g)))};$(document).on("mousemove touchmove",
A);B=function(b){a.resizeable&&(H=!1,e.css("cursor",""),$("html").css("cursor",""));a.draggable&&(G=!1,e.css("cursor","move"));$(document).unbind(".disableSelection");$("[data-popup]").css("user-select","")};$(document).on("mouseup touchend",B);d.on("mousedown touchstart",function(){a.draggable&&U()});k.on("click",function(){a.overlayClose&&n()});$(document).on("keydown",function(b){b.which==a.keyClose&&d.css("z-index")==F()&&C&&n()});w.children("div").on("mousedown touchstart",function(b){a.resizeable&&
(H=!0,l=c.offset().top,m=c.offset().left,r=c.height(),t=c.width(),f=b.pageY||b.originalEvent.touches[0].pageY,g=b.pageX||b.originalEvent.touches[0].pageX,v=$(this).index(),e.css("cursor",$(this).css("cursor")),$("html").css("cursor",$(this).css("cursor")),$("[data-popup]").css("user-select","none"),$(document).bind("selectstart.disableSelection",function(a){a.preventDefault()}))});return u.progress(b)};this.close=function(){n();return this};this.addClass=function(a){d.addClass(a);return this};this.removeClass=
function(a){d.removeClass(a);return this};this.title=function(b){if(void 0==b)return a.title;e.html(a.fTitle);a.title=b;return this};this.content=function(b){if(void 0==b)return a.content;h.html(a.fContent);a.content=b;return this};this.buttons=function(b){if(void 0==b)return a.buttons;a.buttons=b;y.html(R());N();return this};this.overlay=function(b){if(void 0==b)return a.overlay;a.overlay=b?!0:!1;J();return this};this.draggable=function(b){if(void 0==b)return a.draggable;a.draggable=b?!0:!1;L();
return this};this.resizeable=function(b){if(void 0==b)return a.resizeable;a.resizeable=b?!0:!1;M();return this};this.closeButton=function(b){if(void 0==b)return a.closeButton;a.closebutton=b?!0:!1;O();return this};this.popupClass=function(b){if(void 0==b)return a.popupClass;c.removeClass(a.popupClass).addClass(b);a.popupClass=b;return this};this.wrapperClass=function(b){if(void 0==b)return a.wrapperClass;d.removeClass(a.wrapperClass).addClass(b);a.wrapperClass=b;return this};this.overlayClass=function(b){if(void 0==
b)return a.overlayClass;k.removeClass(a.overlayClass).addClass(b);a.overlayClass=b;return this};this.titleClass=function(b){if(void 0==b)return a.titleClass;e.removeClass(a.titleClass).addClass(b);a.titleClass=b;return this};this.contentClass=function(b){if(void 0==b)return a.contentClass;h.removeClass(a.contentClass).addClass(b);a.contentClass=b;return this};this.buttonsClass=function(b){if(void 0==b)return a.buttonsClass;y.removeClass(a.buttonsClass).addClass(b);a.buttonsClass=b;return this};this.overflowXClass=
function(b){if(void 0==b)return a.overflowXClass;d.removeClass(a.overflowXClass).addClass(b);a.overflowXClass=b;return this};this.overflowYClass=function(b){if(void 0==b)return a.overflowYClass;d.removeClass(a.overflowYClass).addClass(b);a.overflowYClass=b;return this};this.scrollTopClass=function(b){if(void 0==b)return a.scrollTopClass;d.removeClass(a.scrollTopClass).addClass(b);a.scrollTopClass=b;return this};this.scrollBottomClass=function(b){if(void 0==b)return a.scrollBottomClass;d.removeClass(a.scrollBottomClass).addClass(b);
a.scrollBottomClass=b;return this};this.closeButtonClass=function(b){if(void 0==b)return a.closeButtonClass;q.removeClass(a.closeButtonClass).addClass(b);a.closeButtonClass=b;return this};this.closeButtonContent=function(b){if(void 0==fCloseButtonHTML)return a.closeButtonContent;q.html(closeButtonContent);a.closeButtonContent=b;return this};this.speed=function(b){if(void 0==fSpeed)return a.speed;a.speed=fSpeed;return this};this.position=function(b){if(void 0==b)return a.position;d.removeAttr("data-position").attr("data-position",
b);a.position=b;a.offset.y=0;a.offset.x=0;p();p();return this};this.offset=function(b){if(void 0==b){b={};switch(a.position){case "center":case "left":case "right":b.y=d.offset().top-c.offset().top-c.outerHeight()/2;break;case "top":case "topLeft":case "topRight":case "stretchTop":case "stretchLeft":case "stretchRight":b.y=d.offset().top-c.offset().top;break;case "bottom":case "bottomLeft":case "bottomRight":case "stretchBottom":b.y=d.offset().top-c.offset().top-c.outerHeight()}switch(a.position){case "center":case "top":case "bottom":b.x=
c.offset().left-d.offset().left+c.outerWidth()/2;break;case "left":case "topLeft":case "bottomLeft":case "stretchTop":case "stretchLeft":case "stretchBottom":b.x=c.offset().left-d.offset().left;break;case "right":case "topRight":case "bottomRight":case "stretchRight":b.x=c.offset().left-d.offset().left+c.outerWidth()}b.y=Math.round(b.y);b.x=Math.floor(b.x);return b}Q(void 0==b.x?0:b.x,void 0==b.y?0:b.y);return this};this.overlayClose=function(b){if(void 0==b)return a.overlayClose;a.overlayClose=b?
!0:!1;return this};this.stickToBottom=function(b){if(void 0==b)return a.stickToBottom;a.stickToBottom=b?!0:!1;a.offset.y=0;a.offset.x=0;p();p()};this.keyClose=function(b){if(void 0==b)return a.keyClose;a.keyClose=b?b:!1};this.popupWrapper=function(){return d};this.popupOverlay=function(){return k};this.popup=function(){return c};this.popupTitle=function(){return e};this.popupContent=function(){return h};this.popupButtons=function(){return y};this.popupClose=function(){return q}};
